...
def upgrade() -> None:
    ...
    # Unique constraints are per-organization (different orgs can have same asset tags)
    op.create_index('ix_assets_org_asset_tag', 'assets', ['organization_id', 'asset_tag'], unique=True)
    op.create_index('ix_assets_asset_type', 'assets', ['asset_type'])
    op.create_index('ix_assets_category', 'assets', ['category'])
    op.create_index('ix_assets_subscription', 'assets', ['subscription'])
    op.create_index('ix_assets_org_serial_number', 'assets', ['organization_id', 'serial_number'], unique=True)
